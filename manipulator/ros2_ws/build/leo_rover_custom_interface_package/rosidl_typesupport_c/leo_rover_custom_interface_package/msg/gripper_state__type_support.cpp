...
static const _GripperState_type_support_symbol_names_t _GripperState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, leo_rover_custom_interface_package, msg, GripperState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, leo_rover_custom_interface_package, msg, GripperState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, leo_rover_custom_interface_package, msg, GripperState)() {
  return &::leo_rover_custom_interface_package::msg::rosidl_typesupport_c::GripperState_message_type_support_handle;
}
