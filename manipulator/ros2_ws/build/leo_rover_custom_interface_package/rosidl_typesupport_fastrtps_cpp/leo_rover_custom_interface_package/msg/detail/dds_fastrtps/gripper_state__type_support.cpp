...
#include "leo_rover_custom_interface_package/msg/detail/gripper_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = leo_rover_custom_interface_package::msg::GripperState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const leo_rover_custom_interface_package::msg::GripperState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<leo_rover_custom_interface_package::msg::GripperState *>(
    untyped_ros_message);
...
{
  return &leo_rover_custom_interface_package::msg::typesupport_fastrtps_cpp::_GripperState__handle;
}
