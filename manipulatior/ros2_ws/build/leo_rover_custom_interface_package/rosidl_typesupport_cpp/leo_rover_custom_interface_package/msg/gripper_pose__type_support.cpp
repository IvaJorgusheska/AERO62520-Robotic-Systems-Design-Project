...
static const _GripperPose_type_support_symbol_names_t _GripperPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, leo_rover_custom_interface_package, msg, GripperPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, leo_rover_custom_interface_package, msg, GripperPose)),
  }
};
...
{
  return &::leo_rover_custom_interface_package::msg::rosidl_typesupport_cpp::GripperPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, leo_rover_custom_interface_package, msg, GripperPose)() {
  return get_message_type_support_handle<leo_rover_custom_interface_package::msg::GripperPose>();
}
